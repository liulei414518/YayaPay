...
export default class DialogDemo extends Component { 
	...
	funLoading(){
		...
		this.refs.dLoading.show(options) 
	}
	...
	render() {
		...
		return (
			...
			<TouchableHighlight 
				style={[styles.comBtnBtnView,{width:100}]} 
				underlayColor='transparent' 
				onPress={this.funLoading.bind(this)}>  
				<Text style={[styles.comBtnText]}>loading</Text>  
			</TouchableHighlight>
			...
			<CommonDialog types={'alert'} components={<Loading/>}   ref="dLoading" />
...
class DefineCon extends Component{
	...
	render(){
		return(
			<View style={[styles.conMid]}>
			<Image source={require('./imgs/alert.png')} style={{width:32,height:32}} />
